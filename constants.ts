...
export const KICK_STREAMERS: { username: string; tags: string[]; character: string }[] = [
  ...
  { username: 'kawd10', tags: ['CIA', 'DA Deputy Director'], character: 'Martin Peterson' },
  ...
  { username: 'LiRx', tags: ['CIA', 'Border Breaking Battalion Deputy Leader'], character: 'Marcus' },
  ...
  { username: '1RWi', tags: ['CIA', 'Death Battelion Deputy Director'], character: 'Ms.Caplin' },
  { username: 'odn35', tags: ['CIA', 'DS Deputy Director', 'DS'], character: 'Benny Surge "Agent-Gaster"' },
  ...
  { username: 'Fwaz', tags: ['CIA', 'CIA Leaders', 'DOU Leader'], character: 'Fwaz Jnaza' },
  { username: 'D7MX', tags: ['CIA', 'CIA Leaders', 'Executive Director'], character: 'Echo' },
  { username: 'Abdullahx', tags: ['CIA', 'CIA Deputy Leader'], character: 'Bravo' },
];
