...
export const KICK_STREAMERS: { username: string; tags: string[]; character: string }[] = [
  ...
  { username: 'lMeshari', tags: ['CIA', 'CIA Leaders', 'DA Director'], character: 'Michael Conner' },
  ...
  { username: 'Vilon', tags: ['Agent'], character: 'Musa3d' },
  { username: 'odn35', tags: ['CIA', 'DS'], character: 'None' },
  { username: 'VMalik', tags: ['CIA', 'DS'], character: 'None' },
